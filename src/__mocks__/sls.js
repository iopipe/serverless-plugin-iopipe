      ...
      },
      {
        ...
        "commands": {
          "create": {
            ...
            "options": {
              "template": {
                "usage": "Template for the service. Available templates: \"aws-nodejs\", \"aws-python\", \"aws-groovy-gradle\", \"aws-java-maven\", \"aws-java-gradle\", \"aws-scala-sbt\", \"aws-csharp\", \"azure-nodejs\", \"openwhisk-nodejs\" and \"plugin\"",
                "required": true,
                "shortcut": "t"
              },
              "path": {
        ...
        "commands": {
          "iopipe": {
            ...
            "options": {
              ...
              "noUpgrade": {
                "usage": "The plugin automatically upgrades the IOpipe library to the most recent minor version. Use this option to disable that feature.",
                "required": false,
                "shortcut": "nu"
              },
              "noYarn": {
                "usage": "When auto-upgrading, Yarn will be used in place of NPM if a yarn.lock file is found. Use this flag disable yarn and use NPM to upgrade the iopipe library.",
                "required": false,
                "shortcut": "ny"
              },
              "exclude": {
